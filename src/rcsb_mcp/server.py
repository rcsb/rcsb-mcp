...
# Transport + editor-link builders live in rcsb_mcp.client (the shared network floor,
# which imports nothing back from here). Names used by tool bodies below are pulled in;
# SEARCH_URL / SEARCH_EDITOR_URL / USER_AGENT / TIMEOUT stay internal to that module.
from rcsb_mcp.client import (  # noqa: E402  (kept next to its former constants for review)
    DATA_GRAPHIQL_URL,
    DATA_GRAPHQL_URL,
